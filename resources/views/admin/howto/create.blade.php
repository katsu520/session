        ...
        <body>
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="row">
              ...
              <img src="{{ asset('/images/5_s.jpg') }}" width="50% height=600px">
            </div>
          </div>

          <div class="col-xs-12 col-lg-12">
            <div class="row">
              <img src="{{ asset('/images/6_s.jpg') }}" width="50% height=600px">
              <div class="item2">
                <dt>リッシュコード</dt>
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="row">
              ...
              <img src="{{ asset('/images/7_s.jpg') }}" width="50% height=600px">
            </div>
          </div>

          <div class="col-xs-12 col-lg-12">
            <div class="row">
              <img src="{{ asset('/images/8_s.jpg') }}" width="50% height=600px">
              <div class="item4">
                <dt>フィン</dt>
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="row">
              ...
              <img src="{{ asset('/images/9_s.jpeg') }}" width="50% height=600px">
            </div>
          </div>

          <div class="col-xs-12 col-lg-12">
            <div class="row">
              <img src="{{ asset('/images/10_s.jpg') }}" width="50% height=600px">
              <div class="item6">
                <dt>ウェットスーツ</dt>
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="row">
              <div class="reference1">
                ...
                <a href="https://surfinglife.jp/category/technic/" class="btn-flat-border" style="margin-top: 380px; margin-left: 275px;">Check</a>
              </div>
              <img src="{{ asset('/images/14_s.jpg')}}" width="50% height=600px">
            </div>
          </div>
          <div class="col-xs-12 col-lg-12">
            <div class="row">
              <img src="{{ asset('/images/15_s.jpg')}}" width="50% height=600px">
              <div class="reference2">
                <dt>ムラサキサポーツ</dt>
                <dd>サーフィンに必要なアイテムが豊富に揃っています!<br>必要な物を揃えてサーフィンに出掛けましょう!</dd>
                <a href="https://www.murasaki.jp/category/SURFING/" class="btn-flat-border" style="margin-top: 350px; margin-left: 280px;">Check</a>
              </div>
            </div>
          </div>
        </body>
